...
export default function SectionTwo() {
  ...
  return (
    <section
      ref={sectionRef}
      className="h-[100vh] snap-start bg-gradient-to-b from-[#324130] to-[#92843B] text-white"
    >
      <div className="h-full grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          ...
          <div className="flex-1 grid grid-rows-3 gap-4">
            {scenarios.map((label, i) => (
              ...
              >
                {/* Scenario Card */}
                <div className="bg-black bg-opacity-50 rounded-md shadow p-4 flex items-center justify-center"
                style={{
                  height: "fit-content",
                  marginTop:"1rem",
                }}
        ...
        <div className="flex-none p-6">
          <motion.div
            ...
            className="w-full h-[85%] rounded-lg shadow-lg overflow-hidden"
            style={{
              marginTop: "5vh",
